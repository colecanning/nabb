...
import { useInstagramWebhookDataStore, useFinalResultStore, useVideoDurationStore, useSearchResultsStore } from '@/lib/store';
...
export default function CyclePage() {
  ...
  // Get search results from Zustand store
